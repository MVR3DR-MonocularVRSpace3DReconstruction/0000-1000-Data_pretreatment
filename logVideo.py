...
def capture(in_left, in_right):
    cmd = "raspivid -w 1280 -h 720 -fps 20 -ISO 800 -ss 12500 -p 0,0,480,270 -cs 1 -t 0 -vf -hf -o {} \
        & raspivid -w 1280 -h 720 -fps 20 -ISO 800 -ss 12500 -p 480,0,480,270 -cs 0 -t 0 -vf -hf -o {}".format(in_left, in_right)
    ...
    while True:
        ...
        if useRaspiCam:
            ...
            if not recording and keyPressed:
                ...
                cmd = "raspivid -w 1280 -h 720 -fps 20 -ISO 1600 -ss 6250 -p 0,0,480,270 -cs 1 -t 0 -vf -hf -o {} \
                    & raspivid -w 1280 -h 720 -fps 20 -ISO 1600 -ss 6250 -p 480,0,480,270 -cs 0 -t 0 -vf -hf -o {}".format(in_left, in_right)
